...
| Related | [`02-eligibility.md`](./02-eligibility.md), [`08-grading-model.md`](./08-grading-model.md) |
...
This chapter defines the **Terms-of-Service (ToS) handling** of the Grading-Spec. ToS handling is part of the **due-diligence** layer, not part of the eligibility gate. A missing ToS link does **not** disqualify a schema; it lowers the score.
...
1. There is a link whose label or anchor text contains "Terms of Service", "Terms of Use", "Terms and Conditions", or a comparable designation in any language.
...
1. write the opinion into the mandatory field `legalAssessment` of the grading entry (see [`08-grading-model.md`](./08-grading-model.md)), and
...
- [`08-grading-model.md`](./08-grading-model.md) — Defines the `legalAssessment` field and its disclaimer requirement.
