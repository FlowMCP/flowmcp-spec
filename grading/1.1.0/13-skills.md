...
The skill types are therefore already semantically distinguished at the Schemas-Spec level. This Grading-Spec chapter makes the **validation consequences** of each type explicit. An optional patch could add a tier-consequence clarification to that v4.1 file directly; absent the patch, this chapter is the binding clarification.
...
— are the binding interpretation of the `type` values for grading purposes. This chapter is the binding source for those tier consequences. An optional v4.1 patch would add a short clarification of the same tier consequences directly in the v4.1 file; absent the patch, this Grading-Spec chapter is the binding location.
...
- An optional v4.1 patch that would mirror this clarification.
