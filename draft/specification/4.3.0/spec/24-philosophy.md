...
| Related | [00-overview.md](./00-overview.md), [01-schema-format.md](./01-schema-format.md), [05-security.md](./05-security.md), [09-validation-rules.md](./09-validation-rules.md), [19-mcp-integration.md](./19-mcp-integration.md) |
...
- [./09-validation-rules.md](./09-validation-rules.md) — see chapter 09.
- [./19-mcp-integration.md](./19-mcp-integration.md) — see chapter 19.
