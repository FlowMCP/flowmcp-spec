...
This repository owns all derived spec payloads. Consumer repos (docs site, CLI, planned Custom-GPT bot) MUST NOT generate spec-derived artifacts themselves. They retrieve pre-generated payloads from `generated/` and handle distribution/rendering only.

Auto-generated files:

- `generated/llms.txt` — concatenated spec bundle for LLM consumption
- `generated/llms-schema-spec.txt` — alias of `llms.txt` for docs-site convention
- `generated/docs-payload/` — Astro-ready Markdown files with frontmatter (see [`generated/docs-payload/README.md`](./generated/docs-payload/README.md))
- `generated/custom-gpt/` — planned, Custom-GPT-bot bundle

All files in `generated/` MUST carry a frontmatter header with `generated_at`, `generated_from`, `generator`, `spec_version`, and `edit_warning`. Hand-editing files in `generated/` is forbidden — changes are overwritten on next build.
...
| `evaluator-docs-payload` | Verify generated/docs-payload/ frontmatter spec | planned |
...
6. `generated/README.md` — what is autogenerated and how
7. `CHANGELOG.md` — recent changes

### Docs-Payload Interface

The `generated/docs-payload/` folder exposes spec content as Astro-ready Markdown files with full frontmatter. This is the **interface contract** for downstream consumers (documentation site, future tools). See [`generated/docs-payload/README.md`](./generated/docs-payload/README.md) for the field specification, the `manifest.json` index format, and consumer obligations.
