# 12. Load & Scale: In-Memory, SQLite, Add-ons, Query Bundling

| Field | Value |
|---|---|
| Status | Recommendation |
| Related | [`13-geo-conventions.md`](./13-geo-conventions.md) |
...
- [./13-geo-conventions.md](./13-geo-conventions.md) — see chapter 13.
