...
generated_from: "draft/grading/3.0.0/spec/08-grading-model.md"
generator: "scripts/generate-docs-payload.mjs"
edit_warning: "This file is auto-generated. Source: draft/grading/3.0.0/spec/08-grading-model.md."
---
...
- [./06-determinism-and-tier.md](/grading/determinism-and-tier/) — see chapter 06.
- [./07-scoring-vs-grading.md](/grading/scoring-vs-grading/) — see chapter 07.
- [./09-security-and-development.md](/grading/security-and-development/) — see chapter 09.
- [./10-domain-knowledge.md](/grading/domain-knowledge/) — see chapter 10.
- [./12-personas-contract.md](/grading/personas-contract/) — see chapter 12.
- [./13-skills.md](/grading/skills/) — see chapter 13.
- [./15-versioning-axes.md](/grading/versioning-axes/) — see chapter 15.
- [./16-selection-lockfile.md](/grading/selection-lockfile/) — see chapter 16.
- [./19-folder-layout.md](/grading/folder-layout/) — see chapter 19.
- [./22-workbench-island.md](/grading/workbench-island/) — see chapter 22.
- [./23-index-json.md](/grading/index-json/) — see chapter 23.
