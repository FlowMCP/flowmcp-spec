...
generated_from: "specification/4.3.0/draft/spec/13-resources.md"
generator: "scripts/generate-docs-payload.mjs"
edit_warning: "This file is auto-generated. Source: specification/4.3.0/draft/spec/13-resources.md."
---
...
| Concern | Contract |
|---------|----------|
| **Wire name** | Each query is exposed under `${queryName}_${namespace}` — the same `name_namespace` convention that tools use (see [16-id-schema.md](/specification/id-schema/#cli-adapter)). The **query** name, not the resource name, is the wire name. |
...
- [./11-preload.md](/specification/preload/) — see chapter 11.
- [./14-skills.md](/specification/skills/) — see chapter 14.
- [./19-mcp-integration.md](/specification/mcp-integration/) — see chapter 19.
