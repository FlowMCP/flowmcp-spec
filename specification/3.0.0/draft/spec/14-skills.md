# FlowMCP Specification v3.0.0 — Skills
...
The version string identifies the skill format specification. In this release, the only valid value is `'flowmcp-skill/1.0.0'`. The prefix `flowmcp-skill/` distinguishes skill versioning from schema versioning (`3.x.x`) and shared list versioning.
...
version: '3.0.0'               // this is a schema version, not a skill version
```
