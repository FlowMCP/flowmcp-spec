...
| Depends on | [`00-introduction.md`](./00-introduction.md) |
...
|------|------|---------------------|
| BP-1 | [Readable Interface](./schema-creation/10-readable-interface.md) | Make the schema readable for the LLM, not for the API |
| BP-2 | [Reference Data](./schema-creation/11-reference-data.md) | Maintain recurring lists and value formats once, inherit everywhere |
| BP-3 | [Load & Scale](./schema-creation/12-load-and-scale.md) | Pick the load/store strategy by data size and query ability |
| BP-4 | [Geo Conventions](./schema-creation/13-geo-conventions.md) | Use the established geo defaults instead of rolling your own |
| BP-5 | [Correctness & License](./schema-creation/14-correctness-license.md) | Assume nothing silently, fake nothing, document provenance and rights |
