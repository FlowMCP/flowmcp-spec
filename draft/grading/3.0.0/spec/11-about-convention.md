...
| Related | Schemas-Spec [`13-resources.md`](/specification/resources/), Schemas-Spec [`17-selections.md`](/specification/selections/), [`10-domain-knowledge.md`](./10-domain-knowledge.md), [`12-personas-contract.md`](./12-personas-contract.md), [`13-skills.md`](./13-skills.md), [`19-folder-layout.md`](./19-folder-layout.md), [`21-pre-conditions.md`](./21-pre-conditions.md) |
