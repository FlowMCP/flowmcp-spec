...
- **Development track** (this strategy, the Grade Report). A validation FAIL yields the terminal grade **F = "Not loadable"**. The development gate is unchanged: validate-clean is still required before `stage:production` (see [21-schema-lifecycle.md](./21-schema-lifecycle.md)). Grade F continues to represent a not-loadable schema in the dev/grade-report sense.
...
- [./10-tests.md](./10-tests.md) — see chapter 10.
- [./21-schema-lifecycle.md](./21-schema-lifecycle.md) — see chapter 21.
- [./22-scoring-protocol.md](./22-scoring-protocol.md) — see chapter 22.
